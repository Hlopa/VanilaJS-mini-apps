...
const stepThrouCell = (row, column) => {
	...
	for (let neighbor of neighbors) {
		...
		} else if(direction === 'qown'){
			horizontals[row][column] = true
		}

		//Visit that next cell
		stepThrouCell(nextRow, nextColumn);
	}
};

stepThrouCell(startRow, startColumn);
...
console.log(verticals, horizontals, grid);
